    ...
    var body: some View {
        Group {
            ...
            case .waitingForNIP29Query:
                ContentUnavailableView {
                    Label("Timeline Coming Next", systemImage: "bubble.left.and.bubble.right")
                } description: {
                    Text("Room discovery is live. Message timelines are waiting for NMP’s typed NIP-29 group query surface.")
                }
            case .observing:
                timeline
            }
